...
|---|---|---|
| **BlueRiver AV Manager URL** | `http://localhost:80` | Address of your BlueRiver Web GUI |
...
During comprehensive architectural code auditing, several critical enhancements were engineered into v1.1.0:
